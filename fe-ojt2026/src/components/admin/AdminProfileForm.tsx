...
const AdminProfileForm: React.FC<Props> = ({
    initialData,
    onSubmit,
    isLoading = false,
    userId
        ...
        <div className="space-y-8">
            ...
            <div className="bg-gradient-to-br from-[#E4002B] via-[#D90026] to-[#C0001F] rounded-3xl p-8 text-white relative overflow-hidden shadow-lg">
                ...
                <div className="relative z-10 flex items-center gap-6">
                    ...
                    <div>
                        <h2 className="text-2xl font-black">{formData.name || 'Tên của bạn'}</h2>
                        <p className="text-white/80 text-sm font-semibold">{formData.role}</p>
                    </div>
                </div>
            </div>
