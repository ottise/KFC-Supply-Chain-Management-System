...
export default function ProductPagination({
  ...
  if (totalPages <= 1) return (
    <div className="flex items-center justify-between px-6 py-4 bg-white border-t border-gray-100 rounded-b-4xl">
  ...
  const getPageNumbers = () => {
    ...
    if (totalPages <= maxVisiblePages) {
      ...
      if (safeCurrentPage <= 2) { startPage = 2; endPage = 3; }
      if (safeCurrentPage >= totalPages - 1) { startPage = totalPages - 2; endPage = totalPages - 1; }
    ...
    <div className="flex items-center justify-between px-6 py-4 bg-white border-t border-gray-100 rounded-b-4xl">
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className="px-3 py-2 rounded-lg text-xs font-bold transition-all disabled:opacity-40 hover:bg-gray-100 text-gray-600"
        >
