...
interface Props {
    initialData?: Partial<WarehouseStaffProfile>;
    onSubmit: (data: WarehouseStaffProfile) => void;
    isLoading?: boolean;
    userId?: string;
}
...
const WarehouseStaffProfileForm: React.FC<Props> = ({
    initialData,
    onSubmit,
    isLoading = false,
    userId
    ...
    const [formData, setFormData] = useState<WarehouseStaffProfile>({
        fullName: initialData?.fullName || '',
        phoneNumber: initialData?.phoneNumber || '',
        email: initialData?.email || '',
        role: initialData?.role || 'Warehouse Staff',
    });
    ...
    // Cập nhật formData khi initialData từ parent thay đổi
    React.useEffect(() => {
        if (initialData) {
            setFormData(prev => ({
                ...prev,
                    ...
                    {activeTab === 'profile' ? (
                        <form className="space-y-6" onSubmit={handleSubmit}>
                            ...
                            <div className="flex justify-end gap-3 pt-4">
                                <Link href="/warehouse-staff/replenishment" passHref>
                                    <button
                                        type="button"
...
export default WarehouseStaffProfileForm;
