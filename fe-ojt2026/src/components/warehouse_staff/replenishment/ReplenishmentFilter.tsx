...
export default function ReplenishmentFilter({ onSearch, onFilterStatus, onDateChange, onCreateClick }: FilterProps) {
  const [isOpen, setIsOpen] = useState(false);
  const [selected, setSelected] = useState("Tất Cả Trạng Thái");
  ...
  const statuses = [
    { label: "Tất Cả Trạng Thái", value: "", color: "bg-gray-300" },
    { label: "Nháp", value: "Nháp", color: "bg-gray-400" },
    { label: "Sẵn Sàng", value: "Sẵn sàng", color: "bg-blue-500" },
    { label: "Nhận Một Phần", value: "Nhận một phần", color: "bg-orange-500" },
    { label: "Đã Hoàn Thành", value: "Đã hoàn thành", color: "bg-green-500" },
  ];
        ...
        <div className="flex gap-4 flex-1">
          ...
          <div className="relative w-full max-w-xl group">
            ...
            <input
              ...
              spellCheck={false}
              type="text"
              placeholder="Tìm theo nhà cung cấp, mã phiếu, vị trí..."
      ...
      <div className="flex flex-wrap gap-6 items-center border-t border-gray-100 pt-4">
        ...
        <div className="flex items-center gap-4">
          <label htmlFor="filter-from-date" className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] cursor-pointer">
            {dateMode === 'created' ? 'Đặt từ ngày:' : 'Giao từ ngày:'}
          </label>
          <div className="relative group kfc-receipt-datepicker-container">
            <DatePicker
              id="filter-from-date"
              locale="vi"
        ...
        <button 
          onClick={() => { setFromDate(""); setToDate(""); setDateMode('created'); }}
