        ...
        try {
          ...
          if (user?.role === 'Manager') {
            ...
            if (!isNaN(rawId)) {
              ...
              locItems = await locationsApi.getAllLocations();
            }
          } else {
            locItems = await locationsApi.getAllLocations();
          }
                    ...
                    <div className="space-y-2">
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          rows={2}
                          className="w-full resize-none rounded-lg border border-gray-100 bg-gray-50/50 kfc-form-field-shadow px-2 py-1.5 text-[10px] leading-snug font-bold text-gray-800 outline-none focus:border-red-100/50 focus:bg-white focus:ring-2 focus:ring-red-50/30 transition-all placeholder:text-gray-400 min-h-[48px] max-h-28"
