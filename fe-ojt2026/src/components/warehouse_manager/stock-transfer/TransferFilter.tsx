...
export default function TransferFilter({
    ...
    const statuses = [
        ...
        { label: "Đang chờ xử lý", value: "WAITING", color: "bg-orange-400" },
                    ...
                    <div className="relative" ref={dropdownRef}>
                        ...
                        >
                            <span className="flex items-center gap-3">
                                <span className={`w-2.5 h-2.5 rounded-full ${statuses.find(s => s.label === selectedStatus)?.color || 'bg-gray-300'} shadow-sm transition-all duration-300`}></span>
                                {selectedStatus}
                            </span>
