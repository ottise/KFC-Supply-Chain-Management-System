...
import StockTransferDashboard from "@/components/warehouse_manager/stock-transfer/StockTransferDashboard";
export default function StockTransferPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-['Inter']">
      <WarehouseNavbar />
      <div className="flex">
        {/* Đảm bảo activePage được set đúng để Sidebar highlight */}
        <WarehouseSidebar activePage="stock-transfer" />
