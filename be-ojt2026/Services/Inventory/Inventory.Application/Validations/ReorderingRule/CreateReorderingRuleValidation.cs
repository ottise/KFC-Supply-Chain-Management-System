...
public class CreateReorderingRuleValidation : AbstractValidator<CreateReorderingRuleRequest>
{
    public CreateReorderingRuleValidation()
    {
        RuleFor(x => x.ProductWarehouseId)
            .GreaterThan(0).WithMessage("ID của kho lưu sản phẩm phải lớn hơn 0");
